...
class PhrasesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create phrase" do
    assert_difference("Phrase.count") do
      post phrases_url, params: { phrase: { description: @phrase.description, key_id: @phrase.key_id, language_id: @phrase.language_id, name: @phrase.name } }
    end
  ...
  test "should update phrase" do
    patch phrase_url(@phrase), params: { phrase: { description: @phrase.description, key_id: @phrase.key_id, language_id: @phrase.language_id, name: @phrase.name } }
